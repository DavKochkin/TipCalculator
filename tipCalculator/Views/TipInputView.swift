...
class TipInputView: UIView {
    ...
    private func observe() {
        tipSubject.sink { [unowned self] tip in
            ...
            case .none: break
            case .tenPercent:
                tenPercentTipButtton.backgroundColor     = ThemeColor.secondary
            case .fifteenPercent:
                fifteenPercentTipButtton.backgroundColor = ThemeColor.secondary
            case .twentyPercent:
                twentyPercentTipButtton.backgroundColor  = ThemeColor.secondary
